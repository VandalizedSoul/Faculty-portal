...
class Qualification(models.Model):
    ...
    from_year = models.IntegerField('from year', max_length=4, choices=YEAR_CHOICES, default=datetime.datetime.now().year)
    to_year = models.IntegerField('to year', max_length=4, choices=YEAR_CHOICES, default=datetime.datetime.now().year)
